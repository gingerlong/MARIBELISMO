...
\rev{
\begin{lemma}
  Let $(T,\lambda) \in \mathcal{T}$ and $Q= \varphi((T,\lambda))$. 
...
\end{lemma}
\begin{proof}
	We start with showing that $(T,\lambda)$ explains $Q$. By construction and
   ...
   By construction of the trees in $\mathcal{T}$ all 0-edges
	...
	with $T^*\simeq Q$ and that explains $Q$ is minimally resolved. 
